...
urlpatterns = [
    path('consultarutilizadores', consultar_utilizadores.as_view(), name='consultar-utilizadores'), #por fazer
    path('escolherperfil', escolher_perfil, name='escolher-perfil'),    #feito
    path('criarutilizadores/<int:id>', criar_utilizador, name='criar-utilizador'), #feito
    ...
    path("logout", logout_action, name="logout"), # feito
    path("login", login_action, name="login"),   #feito
