...
class UtilizadoresTable(django_tables.Table):
    ...
    def render_acoes(self, record):
        ...
        if self.request.user.groups.filter(name='Administrador').exists():
            ...
            """
        terceiro_botao = ""
        if record.firstProfile == 'Cliente':
            alerta = "Tem a certeza que pretende eliminar este utilizador? Atenção! A incrição deste cliente será apagada permanentemente."
        elif record.firstProfile == 'Funcionario':
